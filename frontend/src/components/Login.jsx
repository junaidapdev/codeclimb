...
function Login() {
  ...
  <div className="max-w-[280px] mx-auto">
    <div className="flex flex-col items-center mt-[10vh]">
      ...
      <p className="text-center mt-3 text-[14px] cursor-pointer" onClick={toggleSignInForm}>
      {isSignInForm ? "New to CodeClimb? Sign Up Now" : "Already Registered? Sign In Now"}
      </p>
